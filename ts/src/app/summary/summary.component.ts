...
import { IDropdownMode } from './summaray.interfaces';
...
export class SummaryComponent implements OnInit {
  dropdownMode: IDropdownMode = 'minimized';
  dropdownText = {
    minimized:
  ...
  handleClickDropdown = () => {
    this.dropdownMode =
      this.dropdownMode === 'minimized' ? 'expanded' : 'minimized';

    this.dropdownModeText =
      this.dropdownMode === 'minimized' ? 'ver mais' : 'ver menos';
  };
}
